...
if(isset($_SESSION['user_id'])) {
    ...
    $stat2 = 'SELECT count(*) AS total FROM `users`';
    $query2 = mysqli_query($connection, $stat2);
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block user-dropdown">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user" src="../uploads/profile/<?= $data['image'] ?? 'default.png' ?>"
                                    alt="Header Avatar">
                                <span class="d-none d-xl-inline-block ms-1"><?= $data['name'] ?? 'Admmmmin' ?></span>
