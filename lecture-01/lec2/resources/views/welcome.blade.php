                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    <a href="https://laravel.com/docs"
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">my age is {{ $myage }}
                            </h2>
                    ...
                    @elseif ($id == 5 && $name == 'mohamed')
                    {{ 'there is error' }}
                    @endif
                    {{-- this is blade comment --}}


                    @for ($i = 0 ; $i < 5 ; $i++) <h1> welcome in forloop {{ $i }}
                        @endfor




                        <form action="{{ url('testCsrf') }}" method="post">
                            <form action="bank/ahli?username=ahmed&acount_id=dngsdkglnsdsdsdf&amount=1000"
                                method="post">
                                @csrf
